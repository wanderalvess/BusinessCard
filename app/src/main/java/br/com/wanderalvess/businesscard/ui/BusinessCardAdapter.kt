...
import br.com.wanderalvess.businesscard.databinding.ItemBusinesCardBinding
...
class BusinessCardAdapter :
    ...
    inner class ViewHolder (
        ...
        fun bind(item: BusinessCard) {
            ...
            binding.contentMcv.setCardBackgroundColor(Color.parseColor(item.customBackground))
            binding.contentMcv.setOnClickListener{
                listenerShare(it)
            }
        }
    }
